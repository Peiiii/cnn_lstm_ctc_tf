...
class LSTMOCR(object):
    ...
    def _build_model(self):
        ...
        with tf.variable_scope('lstm'):
            ...
            # print(x.shape)
            # print([self.batch_size, feature_w, feature_h * FLAGS.out_channels])
            x = tf.reshape(x, [self.batch_size, feature_w, feature_h * FLAGS.out_channels])
            ...
            # The second train is the last state and we will not use that
